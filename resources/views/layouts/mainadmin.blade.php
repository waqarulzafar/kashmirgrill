...
<head>
    ...
    <style>
        ...
        body.app-default .kgh-admin-logo {
            height: 60px;
            width: auto;
            object-fit: contain;
        }

        body.app-default .kgh-admin-logo--mini {
            height: 24px;
            width: auto;
            object-fit: contain;
        }
        ...
        body.app-default .app-sidebar .menu .menu-link {
            color: rgba(255, 255, 255, 0.78);
            border-radius: 0.75rem;
            transition: background .2s ease, color .2s ease;
        }

        body.app-default .app-sidebar .menu .menu-link .menu-title,
        body.app-default .app-sidebar .menu .menu-link .menu-icon i {
            color: inherit;
        }
        ...
        body.app-default .btn-primary {
            --bs-btn-bg: var(--kgh-red);
            --bs-btn-border-color: var(--kgh-red);
            --bs-btn-hover-bg: #bb1626;
            --bs-btn-hover-border-color: #bb1626;
            --bs-btn-active-bg: #a41220;
            --bs-btn-active-border-color: #a41220;
        }

        body.app-default .btn-light-primary,
        body.app-default .badge-light-primary {
            color: #fff !important;
            background: rgba(219, 29, 48, 0.25) !important;
            border-color: rgba(219, 29, 48, 0.35) !important;
        }

        body.app-default .btn-light-success,
        body.app-default .badge-light-success {
            color: #fff !important;
            background: rgba(255, 149, 44, 0.22) !important;
            border-color: rgba(255, 149, 44, 0.32) !important;
        }

        body.app-default .btn-light,
        body.app-default .badge-light {
        ...
        html[data-bs-theme="light"] body.app-default .modal-content,
        html[data-bs-theme="light"] body.app-default .dropdown-menu,
        html[data-bs-theme="light"] body.app-default .menu-sub-dropdown {
            background: #ffffff;
            border: 1px solid rgba(0, 0, 0, 0.08);
            box-shadow: 0 14px 28px rgba(0, 0, 0, 0.08);
        }

        html[data-bs-theme="light"] body.app-default .table > :not(caption) > * > * {
            border-bottom-color: rgba(0, 0, 0, 0.09);
        }

        html[data-bs-theme="light"] body.app-default .form-control,
        html[data-bs-theme="light"] body.app-default .form-select,
        html[data-bs-theme="light"] body.app-default .form-control.form-control-solid,
        html[data-bs-theme="light"] body.app-default .form-select.form-select-solid {
            color: #1f1f1f;
            border-color: rgba(0, 0, 0, 0.14);
            background-color: #ffffff;
        }

        html[data-bs-theme="light"] body.app-default .form-control:focus,
        html[data-bs-theme="light"] body.app-default .form-select:focus {
            border-color: rgba(255, 149, 44, 0.7);
        ...
        html[data-bs-theme="dark"] body.app-default .app-wrapper,
        html[data-bs-theme="dark"] body.app-default .app-main,
        html[data-bs-theme="dark"] body.app-default .app-content,
        html[data-bs-theme="dark"] body.app-default .app-container {
            background: transparent;
        }

        html[data-bs-theme="dark"] body.app-default .card,
        html[data-bs-theme="dark"] body.app-default .modal-content,
        html[data-bs-theme="dark"] body.app-default .dropdown-menu,
        html[data-bs-theme="dark"] body.app-default .menu-sub-dropdown {
            background:
        ...
        html[data-bs-theme="dark"] body.app-default .table > :not(caption) > * > * {
            border-bottom-color: rgba(255, 255, 255, 0.11);
        }

        body.app-default .form-control,
        ...
        body.app-default .form-control:focus,
        body.app-default .form-select:focus {
            border-color: rgba(255, 149, 44, 0.6);
            box-shadow: 0 0 0 0.2rem rgba(255, 149, 44, 0.14);
        }

        html[data-bs-theme="dark"] body.app-default .text-gray-900 {
            color: #f5f5f5 !important;
        }

        html[data-bs-theme="dark"] body.app-default .text-gray-800 {
            color: #ececec !important;
        }

        html[data-bs-theme="dark"] body.app-default .text-gray-700,
        html[data-bs-theme="dark"] body.app-default .text-gray-600 {
            color: rgba(255, 255, 255, 0.8) !important;
        }

        html[data-bs-theme="dark"] body.app-default .text-gray-500,
        html[data-bs-theme="dark"] body.app-default .text-muted {
            color: rgba(255, 255, 255, 0.62) !important;
        }

        html[data-bs-theme="dark"] body.app-default .separator {
