...
@section('admin_content')
    <div class="card admin-panel mb-7">
        <div class="admin-panel-head">
            <div>
                <h3 class="admin-panel-title">Filter Activity</h3>
                <p class="admin-panel-copy">Refine the dashboard by date, booking type, status, or guest information.</p>
            </div>
        </div>
    ...
    <div class="row g-5 mb-7">
        ...
        <div class="col-xl-4">
            <div class="card admin-panel mb-5">
                <div class="card-header pt-7 border-0">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-6 gy-4 admin-table">
                            ...
                            <tbody class="fw-semibold text-gray-700">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="admin-empty">No bookings match the current filters.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
