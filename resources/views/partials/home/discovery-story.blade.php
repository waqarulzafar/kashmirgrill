            ...
            <div class="row g-4 g-xl-5 align-items-stretch">
                <div class="col-12 col-lg-6">
                    <div class="home-discovery-story__intro text-start mb-0">
                        <p class="home-discovery-story__eyebrow mb-2">{{ __('Discover') }}</p>
                        <h2 class="home-discovery-story__headline mb-3">
                            {{ __('A welcoming halal restaurant in Como serving Pakistani and Indian favorites for dine-in and takeaway.') }}
                        </h2>
                        <p class="home-discovery-story__brand mb-3">Kashmir Grill House</p>
                        <p class="text-secondary mb-4">
                            {{ __('Kashmir Grill House brings together grills, curries, biryani and rice dishes, starters, and vegetarian options in a casual setting on Via Milano, Como.') }}
                        </p>

                        <div class="home-discovery-story__service-chips mb-4" aria-label="{{ __('Service highlights') }}">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <a href="{{ route('menu') }}" class="btn btn-brand">{{ __('View Menu') }}</a>
                            <a href="{{ route('contact') }}" class="btn btn-brand-outline">{{ __('Contact & Directions') }}</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="home-discovery-story__visual-shell" data-home-story-visual>
                        <div class="home-discovery-story__mosaic">
                            <figure class="home-discovery-story__media-card home-discovery-story__media-card--main">
                                <img src="{{ asset('assets/images/menu/primi-piati/shinwari-chicken-karahi.jpg') }}" alt="{{ __('Signature curry bowl') }}" loading="lazy" decoding="async">
                                <figcaption>{{ __('Main Curry Pick') }}</figcaption>
                            </figure>
                            <figure class="home-discovery-story__media-card home-discovery-story__media-card--top">
                                <img src="{{ asset('assets/images/menu/griglia/beef-seekh-kebab.jpg') }}" alt="{{ __('Seekh kebab plate') }}" loading="lazy" decoding="async">
                                <figcaption>{{ __('Grill Favorite') }}</figcaption>
                            </figure>
                            <figure class="home-discovery-story__media-card home-discovery-story__media-card--bottom">
                                <img src="{{ asset('assets/images/menu/antipasti/paneer-pakora-gpz.jpg') }}" alt="{{ __('Vegetarian starter plate') }}" loading="lazy" decoding="async">
                                <figcaption>{{ __('Starter Option') }}</figcaption>
                            </figure>
                        </div>
            ...
            <article class="home-discovery-story__panel mt-4" data-home-story-panel>
                <div class="row g-4 align-items-center">
                    <div class="col-12 col-lg-7">
                        <p class="home-discovery-story__eyebrow mb-2">{{ __('About The Story') }}</p>
                        <h3 class="h3 mb-3">{{ __('Freshly prepared halal dishes with a menu built for everyday meals and group sharing') }}</h3>
                        <p class="text-secondary mb-3">
                            {{ __('Guests can dine in, place takeaway orders, or use delivery platforms, with phone and social channels available for quick updates and contact.') }}
                        </p>
                        <div class="home-discovery-story__mini-grid">
                            ...
                            <div>
                                <span>{{ __('Access') }}</span>
                                <strong>{{ __('Google Directions') }}</strong>
                            </div>
                        </div>
                    </div>
